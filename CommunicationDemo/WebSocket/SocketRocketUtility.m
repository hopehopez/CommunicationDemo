...
#import "CommunicationDemo-Swift.h"
...
- (void)initHeartBeat
{
    dispatch_main_async_safe(^{
        ...
        heartBeat = [NSTimer timerWithTimeInterval:2 target:self selector:@selector(sentheart) userInfo:nil repeats:YES];
...
//header:
//    {
//    packet_type: str         //报文类型: S2T_3
//    desc: str               //报文描述: 学生端心跳
//    sender: str             //发送方push账号
//    client_type: str         //客户端类型：Android、IOS、Mac、Web
//    }
//    data：
//    {
//    mobile: str            //学生手机号
//    }
    ...
    NSDictionary *dict = @{@"header": @{
                                   @"packet_type": @"S2T_2",
                                   @"desc": @"学生端心跳",
                                   @"sender": [BonjorConfig shared].clientMobile,
                                   @"client_type": @"ios"
                                   },
                           @"data": [BonjorConfig shared].clientMobile
